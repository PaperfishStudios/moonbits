...
public class MBVegetationFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<RandomPatchFeatureConfig, ?>> FLOOD_DESERT_BRUSH =
            ConfiguredFeatures.register("flood_desert_brush", Feature.RANDOM_PATCH, createPatch(24, BlockStateProvider.of(MBBlocks.DESERT_BRUSH)));
    ...
    public static final RegistryEntry<ConfiguredFeature<RandomPatchFeatureConfig, ?>> FLOOD_MARIGOLD_PATCH = ConfiguredFeatures.register(
    ...
    public static final RegistryEntry<ConfiguredFeature<RandomPatchFeatureConfig, ?>> BARREL_CACTI = ConfiguredFeatures.register(
            "barrel_cacti", Feature.RANDOM_PATCH, new RandomPatchFeatureConfig(6, 6, 2,
                    PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(new WeightedBlockStateProvider(new DataPool.Builder<BlockState>()
                            ...
                            .build())))));
    public static final RegistryEntry<ConfiguredFeature<RandomPatchFeatureConfig, ?>> FLOOD_BARREL_CACTI = ConfiguredFeatures.register(
    ...
    public static final RegistryEntry<ConfiguredFeature<RandomPatchFeatureConfig, ?>> HEATHER = ConfiguredFeatures.register(
            "heather", Feature.RANDOM_PATCH, new RandomPatchFeatureConfig(32, 2, 2,
                    PlacedFeatures.createEntry(Feature.SIMPLE_BLOCK, new SimpleBlockFeatureConfig(new NoiseBlockStateProvider(1985L,
                            new DoublePerlinNoiseSampler.NoiseParameters(0, 1.0D), 0.010633334F, HEATHER_LIST))
                    )));
...
//                            .build())))));
    ...
    public static final RegistryEntry<ConfiguredFeature<RandomFeatureConfig, ?>> PASTURE_TREES;
    ...
    static {
        ...
        PASTURE_TREES = ConfiguredFeatures.register("pas_trees", Feature.RANDOM_SELECTOR,
                new RandomFeatureConfig(List.of(
