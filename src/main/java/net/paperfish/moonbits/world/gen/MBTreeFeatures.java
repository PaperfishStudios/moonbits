...
public class MBTreeFeatures {
    ...
    public static final FallenLogFeature FALLEN_LOG = Registry.register(Registry.FEATURE, "fallen_log_feature", new FallenLogFeature(FallenLogConfig.CODEC));
    ...
    public static final RegistryEntry<ConfiguredFeature<RandomFeatureConfig, ?>> JUNIPER_TREES;
    public static final RegistryEntry<ConfiguredFeature<RandomFeatureConfig, ?>> BADLANDS_TREES;

    public static final RegistryEntry<ConfiguredFeature<FallenLogConfig, ?>>  FALLEN_OAK =
            ConfiguredFeatures.register("fallen_oak", FALLEN_LOG, new FallenLogConfig(UniformIntProvider.create(4, 5), BlockStateProvider.of(Blocks.OAK_LOG.getDefaultState())));
    public static final RegistryEntry<ConfiguredFeature<FallenLogConfig, ?>>  FALLEN_BIRCH =
            ConfiguredFeatures.register("fallen_birch", FALLEN_LOG, new FallenLogConfig(UniformIntProvider.create(4, 5), BlockStateProvider.of(Blocks.BIRCH_LOG.getDefaultState())));
    public static final RegistryEntry<ConfiguredFeature<FallenLogConfig, ?>>  FALLEN_SPRUCE =
            ConfiguredFeatures.register("fallen_spruce", FALLEN_LOG, new FallenLogConfig(UniformIntProvider.create(4, 6), BlockStateProvider.of(Blocks.SPRUCE_LOG.getDefaultState())));
    public static final RegistryEntry<ConfiguredFeature<FallenLogConfig, ?>>  FALLEN_JUNIPER =
            ConfiguredFeatures.register("fallen_juniper", FALLEN_LOG, new FallenLogConfig(UniformIntProvider.create(4, 5), BlockStateProvider.of(MBBlocks.JUNIPER_LOG.getDefaultState())));
...
//                        .add(MBBlocks.BUDDING_OAK_LEAVES.getDefaultState(), 2)
    ...
    static {
        ...
        JUNIPER_TREES = ConfiguredFeatures.register("juniper_trees", Feature.RANDOM_SELECTOR,
        ...
        BADLANDS_TREES = ConfiguredFeatures.register("badlands_trees", Feature.RANDOM_SELECTOR,
                new RandomFeatureConfig(List.of(
