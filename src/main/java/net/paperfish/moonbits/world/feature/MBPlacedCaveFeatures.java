...
public class MBPlacedCaveFeatures {
    public static void registerFeatures() {
        ...
        // peat deposits
        RegistryKey<PlacedFeature> p_peat_swamp = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_peat_swamp"));
        ...
        // lush clay deposits
        RegistryKey<PlacedFeature> p_lush_clay = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_lush_clay"));
        ...
        RegistryKey<PlacedFeature> p_gold_high = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_gold_high"));
        ...
        // regolith floor
        RegistryKey<PlacedFeature> p_rg_floor = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_rg_floor"));
        ...
        RegistryKey<PlacedFeature> p_tg_veg = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_tg_veg"));
        ...
        // lamproot
        RegistryKey<PlacedFeature> p_lamproot = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_lamproot"));
        ...
        // caveblooms
        RegistryKey<PlacedFeature> p_caveblooms = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_caveblooms"));
        ...
        BiomeModifications.create(new Identifier(MoonbitsMain.MOD_ID,"moonbits_swamps"))
                .add(ModificationPhase.ADDITIONS, BiomeSelectors.categories(
        ...
        BiomeModifications.create(new Identifier(MoonbitsMain.MOD_ID,"mb_lush"))
        ...
        BiomeModifications.create(new Identifier(MoonbitsMain.MOD_ID,"mb_meadow"))
                .add(ModificationPhase.ADDITIONS, BiomeSelectors.includeByKey(
                        BiomeKeys.MEADOW
                ), (c) -> {
                    c.getGenerationSettings().addCarver(GenerationStep.Carver.AIR, MBCaveFeatures.dirt_cave);
