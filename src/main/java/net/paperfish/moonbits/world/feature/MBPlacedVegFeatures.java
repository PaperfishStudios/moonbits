...
public class MBPlacedVegFeatures {
    public static void registerFeatures() {
        // pebbles
        RegistryKey<PlacedFeature> p_pebbles = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_pebbles"));
        ...
        // wild carrots
        RegistryKey<PlacedFeature> wild_carrot_patch = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_wild_carrots"));
        ...
        // wild potatoes
        RegistryKey<PlacedFeature> wild_potato_patch = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_wild_potatoes"));
        ...
        // sea beets
        RegistryKey<PlacedFeature> sea_beets_patch = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_sea_beets"));
        ...
        // coarse dirt floor
        RegistryKey<PlacedFeature> p_coarse_dirt_patch = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_coarse_dirt_patch"));
        ...
        RegistryKey<PlacedFeature> p_coarse_dirt_floor = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_coarse_dirt_floor"));
        ...
        // podzol floor
        RegistryKey<PlacedFeature> p_podzol_patch = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_podzol_patch"));
        ...
        // buttercup patch!
        RegistryKey<PlacedFeature> buttercup_patch = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_buttercups"));
        Registry.register(BuiltinRegistries.PLACED_FEATURE, buttercup_patch.getValue(),
                MBVegetationFeatures.BUTTERCUP_PATCH.withPlacement(
                        CountPlacementModifier.of(3), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of()));
        // forget-me-not patch!
        RegistryKey<PlacedFeature> forgetmenot_patch = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_forgetmenot"));
        ...
        RegistryKey<PlacedFeature> p_mbff_flowers = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_mbff_flowers"));
        ...
        RegistryKey<PlacedFeature> p_super_golden_birch = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_sgb_0002"));
        ...
        // fallen trees
        RegistryKey<PlacedFeature> p_fallen_oak = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_fallen_oak"));
        Registry.register(BuiltinRegistries.PLACED_FEATURE, p_fallen_oak.getValue(), MBTreeFeatures.FALLEN_OAK.withPlacement(
                CountPlacementModifier.of(1), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of()));
        RegistryKey<PlacedFeature> p_fallen_birch = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_fallen_birch"));
        Registry.register(BuiltinRegistries.PLACED_FEATURE, p_fallen_birch.getValue(), MBTreeFeatures.FALLEN_BIRCH.withPlacement(
                CountPlacementModifier.of(1), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of()));
        RegistryKey<PlacedFeature> p_fallen_spruce = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_fallen_spruce"));
        Registry.register(BuiltinRegistries.PLACED_FEATURE, p_fallen_spruce.getValue(), MBTreeFeatures.FALLEN_SPRUCE.withPlacement(
                CountPlacementModifier.of(1), SquarePlacementModifier.of(), PlacedFeatures.MOTION_BLOCKING_HEIGHTMAP, BiomePlacementModifier.of()));

        // meadow flowers
        RegistryKey<PlacedFeature> p_meadow_flowers = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(MoonbitsMain.MOD_ID, "p_meadow_flowers"));
        ...
        BiomeModifications.create(new Identifier(MoonbitsMain.MOD_ID,"moonbits_forests"))
        ...
        BiomeModifications.create(new Identifier(MoonbitsMain.MOD_ID,"moonbits_flower_forests"))
        ...
        BiomeModifications.create(new Identifier(MoonbitsMain.MOD_ID,"moonbits_meadow"))
        ...
        BiomeModifications.create(new Identifier(MoonbitsMain.MOD_ID,"moonbits_birch_forests"))
        ...
        BiomeModifications.create(new Identifier(MoonbitsMain.MOD_ID,"moonbits_tall_birch_forests"))
        ...
        // river modifications
        BiomeModifications.create(new Identifier(MoonbitsMain.MOD_ID,"moonbits_rivers"))
