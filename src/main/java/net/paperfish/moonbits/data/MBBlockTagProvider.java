...
public class MBBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void generateTags() {
        ...
        this.getOrCreateTagBuilder(BlockTags.PICKAXE_MINEABLE).add(
				...
				MBBlocks.COPPER_SHINGLES, MBBlocks.EXPOSED_COPPER_SHINGLES,
				MBBlocks.WEATHERED_COPPER_SHINGLES, MBBlocks.OXIDIZED_COPPER_SHINGLES,
				MBBlocks.WAXED_COPPER_SHINGLES, MBBlocks.WAXED_EXPOSED_COPPER_SHINGLES,
				MBBlocks.WAXED_WEATHERED_COPPER_SHINGLES, MBBlocks.WAXED_OXIDIZED_COPPER_SHINGLES,

				MBBlocks.COPPER_BARS, MBBlocks.EXPOSED_COPPER_BARS,
				MBBlocks.WEATHERED_COPPER_BARS, MBBlocks.OXIDIZED_COPPER_BARS,
				MBBlocks.WAXED_COPPER_BARS, MBBlocks.WAXED_EXPOSED_COPPER_BARS,
				MBBlocks.WAXED_WEATHERED_COPPER_BARS, MBBlocks.WAXED_OXIDIZED_COPPER_BARS,

				MBBlocks.COPPER_LADDER, MBBlocks.EXPOSED_COPPER_LADDER,
				MBBlocks.WEATHERED_COPPER_LADDER, MBBlocks.OXIDIZED_COPPER_LADDER,
				MBBlocks.WAXED_COPPER_LADDER, MBBlocks.WAXED_EXPOSED_COPPER_LADDER,
				MBBlocks.WAXED_WEATHERED_COPPER_LADDER, MBBlocks.WAXED_OXIDIZED_COPPER_LADDER,

				MBBlocks.COPPER_TRAPDOOR, MBBlocks.EXPOSED_COPPER_TRAPDOOR,
				MBBlocks.WEATHERED_COPPER_TRAPDOOR, MBBlocks.OXIDIZED_COPPER_TRAPDOOR,
				MBBlocks.WAXED_COPPER_TRAPDOOR, MBBlocks.WAXED_EXPOSED_COPPER_TRAPDOOR,
				MBBlocks.WAXED_WEATHERED_COPPER_TRAPDOOR, MBBlocks.WAXED_OXIDIZED_COPPER_TRAPDOOR,
...
//        );
		...
		this.getOrCreateTagBuilder(BlockTags.TRAPDOORS).add(
				MBBlocks.COPPER_TRAPDOOR, MBBlocks.EXPOSED_COPPER_TRAPDOOR,
				MBBlocks.WEATHERED_COPPER_TRAPDOOR, MBBlocks.OXIDIZED_COPPER_TRAPDOOR,
				MBBlocks.WAXED_COPPER_TRAPDOOR, MBBlocks.WAXED_EXPOSED_COPPER_TRAPDOOR,
				MBBlocks.WAXED_WEATHERED_COPPER_TRAPDOOR, MBBlocks.WAXED_OXIDIZED_COPPER_TRAPDOOR
