...
public class DimWeatheringBlock extends Block implements DimensionalWeathering {
    public final Block overworld;
    public final Block nether;
    public final Block end;
    public DimWeatheringBlock(Block overworld, Block nether, Block end, Settings settings) {
        super(settings);
