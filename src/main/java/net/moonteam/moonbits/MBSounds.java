...
public class MBSounds {
    ...
    public static SoundEvent BABY_GRIZZ_AMBIENT = register("entity.mbgrizzly.ambient");
    public static SoundEvent GRIZZLY_DEATH = register("entity.mbgrizzly.ambient");
    public static SoundEvent GRIZZLY_HURT = register("entity.mbgrizzly.ambient");
    public static SoundEvent GRIZZLY_STEPS = register("entity.mbgrizzly.ambient");
    public static SoundEvent GRIZZLY_WARN = register("entity.mbgrizzly.ambient");
