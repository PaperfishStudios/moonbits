...
public class MBTreeFeatures {
    ...
    public static final BrownMushroomFeature SAFFRON_MUSHROOM_FEATURE =
            Registry.register(Registry.FEATURE, new Identifier(Moonbits.MODID, "saffron_mushroom_feature"), new BrownMushroomFeature(HugeMushroomFeatureConfig.CODEC));
